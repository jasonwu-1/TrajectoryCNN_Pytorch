...
train_data_paths ='cmu_ske/train_cmu_20.npy'
valid_data_paths ='cmu_ske/train_cmu_20.npy'
test_data_paths ='cmu_ske/testset'
save_dir ='checkpoints/cmu/traj_cmu_short_term/v3'
gen_dir ='results/cmu/traj_cmu_short_term/v3'
bak_dir ='backup/cmu/traj_cmu_short_term/v3'
# model parameter
pretrained_model=''
input_length= 10
seq_length =20
