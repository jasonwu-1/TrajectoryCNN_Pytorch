...
train_data_paths ='h36m20/h36m20_train_3d.npy'
valid_data_paths ='h36m20/h36m20_val_3d.npy'
test_data_paths ='h36m20/testset'
save_dir ='checkpoints/h36m20/v0'
gen_dir ='results/h36m20/v0'
bak_dir ='backup/h36m20/v0'
# model parameter
pretrained_model=''
input_length= 10
seq_length =20
...
for itr in range(1,max_iterations+1):
    ...
    if itr % test_interval==0:
        ...
        for s in str1:
            ...
            tem = np.load(test_data_paths + '/' + s + '.npy')
            ...
            test_time+=t1
            # img_gen =np.concatenate(img_gen.cpu().detach().numpy())
