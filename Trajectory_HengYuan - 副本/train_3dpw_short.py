...
train_data_paths ='3dpw_ske/train_3dpw0_25.npy'
valid_data_paths ='3dpw_ske/test_3dpw0_25.npy'
save_dir ='checkpoints/3dpw/traj_3dpw/v0'
gen_dir ='results/3dpw/traj_3dpw/v0'
bak_dir ='backup/3dpw/traj_3dpw/v0'
# model parameter
pretrained_model=''
input_length= 10
seq_length =25
